...
const Python = (props: SVGProps<SVGSVGElement>) => (
  <svg fill='none' viewBox='16 16 32 32' width='1em' height='1em' className='icon' {...props}>
    <path
      fill='url(#a4)'
    ...
    />
    <defs>
      <linearGradient id='a4' x1={19.075} x2={34.898} y1={18.782} y2={34.658} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#387EB8' />
        <stop offset={1} stopColor='#366994' />
      </linearGradient>
      <linearGradient id='b4' x1={28.809} x2={45.803} y1={28.882} y2={45.163} gradientUnits='userSpaceOnUse'>
